...
export default function LeaguesScreen({ navigation }) {
    ...
    return (
        <View style={{ flexGrow: 1, backgroundColor: '#FFFFFF' }}>
            <Image source={require("../../assets/2.png")} style={{ backgroundColor: '#FFFFFF', transform: [{ rotate: '180deg' }], position: 'absolute', top: 0, left: 0, right: 0, bottom: 0, zIndex: -1 }} />
            <View style={{ paddingHorizontal: 20, paddingTop: 40 }}>
                <Text style={{ fontFamily: 'varela-round', fontSize: 40, alignSelf: 'center' }}>Ligas</Text>
                <TouchableOpacity
                    onPress={() => {
